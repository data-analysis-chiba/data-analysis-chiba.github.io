...
## Announcements: About the website

- I updated the [website](https://data-analysis-chiba.github.io/)
  - [Materials (readings)](https://data-analysis-chiba.github.io/#materials) are now easier to access
  - [Extra practice](https://data-analysis-chiba.github.io/#extra-practice) has been added

## Announcements: About homework

- I will demonstrate one more time how to access and submit the homework assignment

- You can find the detailed explanation in the [Day 2 materials](../day2/day02_intro_to_git.qmd#part-3-create-clone-stage-commit-push-pull)
...
- Download the `gapminder.csv` file from Moodle and put it in `data_raw`
  - It is also available from [here](https://www.dropbox.com/s/fdirlsnxlzy53qq/gapminder.csv?dl=0)
