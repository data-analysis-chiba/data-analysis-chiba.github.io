...
- A **dataframe** is a **collection of vectors** (like a **spreadsheet** )
...
![Image by Allison Horst](../images/horst_wrangling.png){fig-alt="data wrangling monsters"}
...
- Use `read_csv()` (**not** `read.csv()`) to load a spreadsheet as a dataframe
