...
- The report (`final-report.qmd`) is due **2026-07-31 11:59PM**
  - Push your final commit to GitHub by the deadline

- The **evaluation form** is due **2026-08-07 11:59PM**
  - Submit via Moodle

## Grading

- Please see the **rubric** in the final report instructions on Moodle to understand how the paper will be graded
...
- Once you've reproduced the report, fill out the Final Report Evaluation form on Moodle
