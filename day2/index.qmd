...
- [Mac](https://git-scm.com/download/mac)
  ...
  - If you do need to install git, install [Homebrew](https://brew.sh/) first
...
This is explained in the ["Intro to Git" markdown file](https://github.com/data-analysis-chiba/day02-git/blob/main/day02_intro_to_git.md), which you will copy to your computer when you clone the [Day 2 repo](https://github.com/data-analysis-chiba/day02-git/).

## What to do if the Git pane doesn't work

![](../images/git_empty.png)
