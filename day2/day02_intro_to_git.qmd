...
PAT, 4. Talking to Git via RStudio.
...
### 4. Authenticate with HTTPS (contains excerpts from [Ch 10](https://happygitwithr.com/ssh-keys.html) of [Happy Git and GitHub for the useR](http://happygitwithr.com/))
