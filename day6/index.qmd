...
## Reminder: How to check your project

- By now, you have created many R projects (one per homework, at least)

- Git works **inside a project**
  - So if you aren't in the right project, you won't be able to commit, push, etc.

- If you are unable to commit and push the homework, **check your project**

---

- This is what RStudio looks like with no project selected

![](../images/project-none.png)

-----

- To choose another project, you can either double click the `.Rproj` file, **or**, you can use the project select menu (on the right side of RStudio)

![](../images/project-select.png)

---

- Once you have successfully chosen your project, you will see the project name at the top of the window (and the project selection menu)

![](../images/project-selected-circled.png)
...
- You will also evaluate one **other** student's report, including running their code (**replicating it**)
...
- Your own report is due **2025-07-30 11:59PM**
- Your evaluation of another other report is due **2025-08-06 11:59PM**
  - Assignment of other reports and the evaluation sheet will be posted on Moodle